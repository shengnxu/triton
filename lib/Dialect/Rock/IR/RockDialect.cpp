...
#include "triton/Dialect/Rock/IR/RockOpsDialect.cpp.inc"
#include "triton/Dialect/Rock/IR/RockTypes.cpp.inc"
//===----------------------------------------------------------------------===//
...
#include "triton/Dialect/Rock/IR/RockAttrDefs.cpp.inc"
      >();
  addOperations<
#define GET_OP_LIST
#include "triton/Dialect/Rock/IR/RockOps.cpp.inc"
      >();
