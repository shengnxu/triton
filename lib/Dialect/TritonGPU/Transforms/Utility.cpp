...
auto getMfmaInsnGroupAttrMap = []() -> const MfmaInsnGroupMap & {
  static MfmaInsnGroupMap MfmaInsnMap{
      ...
      {{32, MfmaTypeId::Fp32TyId, 1},
       {32, 32, 2, 1, mlir::ROCDL::mfma_f32_32x32x2f32::getOperationName()}},
      ...
      {{16, MfmaTypeId::Fp32TyId, 1},
       {16, 16, 4, 1, mlir::ROCDL::mfma_f32_16x16x4f32::getOperationName()}},
      ...
      {{4, MfmaTypeId::Fp32TyId, 1},
       {4, 4, 16, 1, mlir::ROCDL::mfma_f32_4x4x1f32::getOperationName()}},
      ...
      {{32, MfmaTypeId::Fp16TyId, 1},
       {32, 32, 8, 4, mlir::ROCDL::mfma_f32_32x32x8f16::getOperationName()}},
      ...
      {{16, MfmaTypeId::Fp16TyId, 1},
       {16, 16, 16, 4, mlir::ROCDL::mfma_f32_16x16x16f16::getOperationName()}},
      ...
      {{4, MfmaTypeId::Fp16TyId, 1},
       {4, 4, 64, 4, mlir::ROCDL::mfma_f32_4x4x4f16::getOperationName()}},
      ...
      {{32, MfmaTypeId::Bf16TyId, 1},
       {32, 32, 4, 2, mlir::ROCDL::mfma_f32_32x32x4bf16::getOperationName()}},
      // mfma_f32_32x32x8_bf16_1K
      {{32, MfmaTypeId::Bf16TyId, 2},
       {32, 32, 8, 4,
        mlir::ROCDL::mfma_f32_32x32x8bf16_1k::getOperationName()}},
      {{32, MfmaTypeId::Bf16TyId, 3},
       {32, 32, 8, 4,
        mlir::ROCDL::mfma_f32_32x32x8bf16_1k::getOperationName()}},
      // mfma_f32_16x16x8_bf16
      {{16, MfmaTypeId::Bf16TyId, 1},
       {16, 16, 8, 2, mlir::ROCDL::mfma_f32_16x16x8bf16::getOperationName()}},
      // mfma_f32_16x16x16_bf16_1K
      {{16, MfmaTypeId::Bf16TyId, 2},
       {16, 16, 16, 4,
        mlir::ROCDL::mfma_f32_16x16x16bf16_1k::getOperationName()}},
      {{16, MfmaTypeId::Bf16TyId, 3},
       {16, 16, 16, 4,
        mlir::ROCDL::mfma_f32_16x16x16bf16_1k::getOperationName()}},
      // mfma_f32_4x4x2_bf16
      {{4, MfmaTypeId::Bf16TyId, 1},
       {4, 4, 32, 2, mlir::ROCDL::mfma_f32_4x4x2bf16::getOperationName()}},
      // mfma_f32_4x4x4_bf16_1K
      {{4, MfmaTypeId::Bf16TyId, 2},
       {4, 4, 64, 4, mlir::ROCDL::mfma_f32_4x4x4bf16_1k::getOperationName()}},
      {{4, MfmaTypeId::Bf16TyId, 3},
       {4, 4, 64, 4, mlir::ROCDL::mfma_f32_4x4x4bf16_1k::getOperationName()}},
      // int8
      // mfma_f32_32x32x8i8
      {{32, MfmaTypeId::I8TyId, 1},
       {32, 32, 8, 4, mlir::ROCDL::mfma_i32_32x32x8i8::getOperationName()}},
      {{32, MfmaTypeId::I8TyId, 2},
       {32, 32, 8, 4, mlir::ROCDL::mfma_i32_32x32x8i8::getOperationName()}},
      // mfma_f32_32x32x16i8
      {{32, MfmaTypeId::I8TyId, 3},
       {32, 32, 16, 8, mlir::ROCDL::mfma_i32_32x32x16_i8::getOperationName()}},
      // mfma_f32_16x16x16i8
      {{16, MfmaTypeId::I8TyId, 1},
       {16, 16, 16, 4, mlir::ROCDL::mfma_i32_16x16x16i8::getOperationName()}},
      {{16, MfmaTypeId::I8TyId, 2},
       {16, 16, 16, 4, mlir::ROCDL::mfma_i32_16x16x16i8::getOperationName()}},
      // mfma_f32_16x16x32i8
      {{16, MfmaTypeId::I8TyId, 3},
       {16, 16, 32, 8, mlir::ROCDL::mfma_i32_16x16x32_i8::getOperationName()}},
      // mfma_f32_4x4x4i8
      {{4, MfmaTypeId::I8TyId, 1},
       {4, 4, 64, 4, mlir::ROCDL::mfma_i32_4x4x4i8::getOperationName()}},
      ...
      {{32, MfmaTypeId::Fp8Fp8TyId, 3},
       {32, 32, 16, 8,
        mlir::ROCDL::mfma_f32_32x32x16_fp8_fp8::getOperationName()}},
      // mfma_f32_16x16x32_FP8_FP8
      {{16, MfmaTypeId::Fp8Fp8TyId, 3},
       {16, 16, 32, 8,
        mlir::ROCDL::mfma_f32_16x16x32_fp8_fp8::getOperationName()}},
      // mfma_f32_32x32x16_FP8_BF8
      {{32, MfmaTypeId::Fp8Bf8TyId, 3},
       {32, 32, 16, 8,
        mlir::ROCDL::mfma_f32_32x32x16_fp8_bf8::getOperationName()}},
      // mfma_f32_16x16x32_FP8_BF8
      {{16, MfmaTypeId::Fp8Bf8TyId, 3},
       {16, 16, 32, 8,
        mlir::ROCDL::mfma_f32_16x16x32_fp8_bf8::getOperationName()}},
      // mfma_f32_32x32x16_BF8_FP8
      {{32, MfmaTypeId::Bf8Fp8TyId, 3},
       {32, 32, 16, 8,
        mlir::ROCDL::mfma_f32_32x32x16_bf8_fp8::getOperationName()}},
      // mfma_f32_16x16x32_BF8_FP8
      {{16, MfmaTypeId::Bf8Fp8TyId, 3},
       {16, 16, 32, 8,
        mlir::ROCDL::mfma_f32_16x16x32_bf8_fp8::getOperationName()}},
      // mfma_f32_32x32x16_BF8_BF8
      {{32, MfmaTypeId::Bf8Bf8TyId, 3},
       {32, 32, 16, 8,
        mlir::ROCDL::mfma_f32_32x32x16_bf8_bf8::getOperationName()}},
      // mfma_f32_16x16x32_BF8_BF8
      {{16, MfmaTypeId::Bf8Bf8TyId, 3},
       {16, 16, 32, 8,
        mlir::ROCDL::mfma_f32_16x16x32_bf8_bf8::getOperationName()}}};
  return MfmaInsnMap;
};

mlir::FailureOr<MfmaInsn> MfmaInsn::selectMfma(unsigned nonKDim,
...
MfmaInsn::MfmaInsn(mlir::Type elementTypeA, mlir::Type elementTypeB,
...
llvm::SmallString<16> MfmaInsn::getInsnName() { return attr.insn; }
