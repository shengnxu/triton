...
if torch.version.hip:
    ...
    # configs = [
    #     triton.Config({'BLOCK_M': BM, 'BLOCK_N': BN, 'PRE_LOAD_V': False}, num_stages=s, num_warps=w) \
    #     for BM in [64, 128]\
    #     for BN in [64, 128]\
    #     for s in [3, 4, 7]\
    #     for w in [4, 8]\
    # ]
    configs = [triton.Config({'BLOCK_M': 128, 'BLOCK_N': 64, 'PRE_LOAD_V': False}, num_stages=1,
                      num_warps=4)] # MI300 config
