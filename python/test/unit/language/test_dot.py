...
@pytest.mark.parametrize("M, N, K, num_warps, col_a, col_b, epilogue, allow_tf32, dtype",
                         [(*shape_nw, col_a, col_b, epilogue, allow_tf32, dtype)
                          for shape_nw in [[128, 64, 16, 8],
                                           [128, 64, 16, 4],
                                           #[128, 64, 16, 2], # fp exception
                                           #[128, 64, 16, 1], # fp exception
                                           [128, 64, 32, 8],
                                           [128, 64, 32, 4],
                                           #[128, 64, 32, 2], # fp exception
                                           #[128, 64, 32, 1], # fp exception
                                           [128, 64, 64, 8],
                                           [128, 64, 64, 4],
                                           #[128, 64, 64, 2], # fp exception
                                           #[128, 64, 64, 1], # fp exception
                                           [128, 32, 16, 4],
                                           #[128, 32, 16, 2], # fp exception
                                           #[128, 32, 16, 1],  # fp exception
                                           [128, 32, 32, 4],
                                           #[128, 32, 32, 2], # fp exception
                                           #[128, 32, 32, 1], # fp exception
                                           [128, 32, 64, 4],
                                           #[128, 32, 64, 2], # fp exception
                                           #[128, 32, 64, 1], # fp exception
                                           [64, 128, 16, 8],
                                           [64, 128, 16, 4],
                                           [64, 128, 16, 2],
                                           #[64, 128, 16, 1], # fp exception
                                           [64, 128, 32, 8],
                                           [64, 128, 32, 4],
                                           [64, 128, 32, 2],
                                           #[64, 128, 32, 1], # fp exception
                                           [64, 128, 64, 8],
                                           [64, 128, 64, 4],
                                           [64, 128, 64, 2],
                                           #[64, 128, 64, 1], # fp exception
                                           [32, 128, 16, 4],
                                           [32, 128, 16, 2],
                                           [32, 128, 16, 1],
                                           [32, 128, 32, 4],
                                           ...
                                           [64, 64, 16, 4],
                                           [64, 64, 16, 2],
                                           #[64, 64, 16, 1], # fp exception
                                           [64, 64, 32, 4],
                                           [64, 64, 32, 2],
                                           #[64, 64, 32, 1], # fp exception
                                           [64, 64, 64, 4],
                                           [64, 64, 64, 2],
                                           #[64, 64, 32, 1], # fp exception
                                           [64, 64, 128, 4],
                                           [64, 64, 128, 2],
                                           #[64, 64, 128, 1], # fp exception
                                           [64, 32, 32, 2],
                                           #[64, 32, 32, 1], # fp exception
                                           [64, 32, 64, 2],
                                           #[64, 32, 64, 1], # fp exception
                                           [64, 32, 128, 2],
                                           #[64, 32, 128, 1], # fp exception
                                           [32, 64, 32, 2],
                                           [32, 64, 32, 1],
                                           [32, 64, 64, 2],
                                           [32, 64, 64, 1],
