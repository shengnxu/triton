...
@triton.autotune(
    configs=[
        triton.Config({'BLOCK_SIZE_M': 256, 'BLOCK_SIZE_N': 256, 'BLOCK_SIZE_K': 128, 'waves_per_eu': 0}, num_warps=8, num_stages=0),
#        triton.Config({'BLOCK_SIZE_M': 128, 'BLOCK_SIZE_N': 256, 'BLOCK_SIZE_K': 32, 'waves_per_eu': 0}, num_warps=8, num_stages=0),
#        triton.Config({'BLOCK_SIZE_M': 128, 'BLOCK_SIZE_N': 256, 'BLOCK_SIZE_K': 16, 'waves_per_eu': 2}, num_warps=4, num_stages=0),
#        triton.Config({'BLOCK_SIZE_M': 128, 'BLOCK_SIZE_N': 128, 'BLOCK_SIZE_K': 32, 'waves_per_eu': 2}, num_warps=8, num_stages=0),
#        triton.Config({'BLOCK_SIZE_M': 128, 'BLOCK_SIZE_N': 64, 'BLOCK_SIZE_K': 32, 'waves_per_eu': 2}, num_warps=4, num_stages=0),
    ],
    key=['M', 'N', 'K'],
    #use_cuda_graph=True,
)
