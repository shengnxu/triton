...
class dtype:
    ...
    FP_TYPES = ['fp8e4b15', 'fp8e4b15x4', 'fp8e4nv', 'fp8e4m3fnuz', 'fp8e5', 'fp8e5m2fnuz', 'fp16', 'bf16', 'fp32', 'fp64']
    ...
    def is_fp8e5m2fnuz(self):
        return self.name == 'fp8e5m2fnuz'
...
float8e5m2fnuz = dtype('fp8e5m2fnuz')
