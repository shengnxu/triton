...
public:
  explicit ReduceOpHelper(triton_rocm::ReduceOp op)
  ...
  triton_rocm::ReduceOp getOperation() { return op; }
...
public:
  explicit ScanLoweringHelper(triton_rocm::ScanOp op) : scanOp(op) {
  ...
  triton_rocm::gpu_rocm::BlockedEncodingAttr getEncoding();
  llvm::ArrayRef<int64_t> getShape();
  Region &getCombineOp();

private:
  triton_rocm::ScanOp scanOp;
  Attribute srcEncoding;
};
