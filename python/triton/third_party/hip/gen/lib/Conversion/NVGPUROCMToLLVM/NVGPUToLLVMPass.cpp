...
namespace ttn = mlir::triton_rocm::nvgpu;
...
class NVGPUROCMOpPatternBase : public mlir::RewritePattern {
public:
  explicit NVGPUROCMOpPatternBase(mlir::MLIRContext *context)
...
class NVGPUROCMOpGenericPattern
    : public NVGPUROCMOpPatternBase<SourceOp, NVGPUROCMOpGenericPattern<SourceOp>> {
public:
  explicit NVGPUROCMOpGenericPattern(mlir::MLIRContext *context, std::string ptxAsm,
                                 std::vector<std::string> outputConstraints,
                                 std::vector<std::string> inputConstraints)
      : NVGPUROCMOpPatternBase<SourceOp, NVGPUROCMOpGenericPattern<SourceOp>>(context),
...
class FenceAsyncSharedOpPattern
    : public NVGPUROCMOpPatternBase<ttn::FenceAsyncSharedOp,
                                FenceAsyncSharedOpPattern> {
public:
  using Base =
      NVGPUROCMOpPatternBase<ttn::FenceAsyncSharedOp, FenceAsyncSharedOpPattern>;
  using Base::Base;
...
class ClusterArriveOpPattern
    : public NVGPUROCMOpPatternBase<ttn::ClusterArriveOp, ClusterArriveOpPattern> {
public:
  using Base = NVGPUROCMOpPatternBase<ttn::ClusterArriveOp, ClusterArriveOpPattern>;
  using Base::Base;
...
class StoreMatrixOpPattern
    : public NVGPUROCMOpPatternBase<ttn::StoreMatrixOp, StoreMatrixOpPattern> {
public:
  using Base = NVGPUROCMOpPatternBase<ttn::StoreMatrixOp, StoreMatrixOpPattern>;
  using Base::Base;
...
class MBarrierArriveOpPattern
    : public NVGPUROCMOpPatternBase<ttn::MBarrierArriveOp,
                                MBarrierArriveOpPattern> {
public:
  using Base =
      NVGPUROCMOpPatternBase<ttn::MBarrierArriveOp, MBarrierArriveOpPattern>;
  using Base::Base;
...
class TMALoadTiledOpPattern
    : public NVGPUROCMOpPatternBase<ttn::TMALoadTiledOp, TMALoadTiledOpPattern> {
public:
  using Base = NVGPUROCMOpPatternBase<ttn::TMALoadTiledOp, TMALoadTiledOpPattern>;
  using Base::Base;
...
class TMAStoreTiledOpPattern
    : public NVGPUROCMOpPatternBase<ttn::TMAStoreTiledOp, TMAStoreTiledOpPattern> {
public:
  using Base = NVGPUROCMOpPatternBase<ttn::TMAStoreTiledOp, TMAStoreTiledOpPattern>;
  using Base::Base;
...
class StoreDSmemOpPattern
    : public NVGPUROCMOpPatternBase<ttn::StoreDSmemOp, StoreDSmemOpPattern> {
public:
  using Base = NVGPUROCMOpPatternBase<ttn::StoreDSmemOp, StoreDSmemOpPattern>;
  using Base::Base;
...
class LoadDSmemOpPattern
    : public NVGPUROCMOpPatternBase<ttn::LoadDSmemOp, LoadDSmemOpPattern> {
public:
  using Base = NVGPUROCMOpPatternBase<ttn::LoadDSmemOp, LoadDSmemOpPattern>;
  using Base::Base;
...
class WGMMAWaitGroupOpPattern
    : public NVGPUROCMOpPatternBase<ttn::WGMMAWaitGroupOp,
                                WGMMAWaitGroupOpPattern> {
public:
  using Base =
      NVGPUROCMOpPatternBase<ttn::WGMMAWaitGroupOp, WGMMAWaitGroupOpPattern>;
  using Base::Base;
...
class WGMMAOpPattern : public NVGPUROCMOpPatternBase<ttn::WGMMAOp, WGMMAOpPattern> {
public:
  using Base = NVGPUROCMOpPatternBase<ttn::WGMMAOp, WGMMAOpPattern>;
  using Base::Base;
...
class OffsetOfSts64OpPattern
    : public NVGPUROCMOpPatternBase<ttn::OffsetOfSts64Op, OffsetOfSts64OpPattern> {
public:
  using Base = NVGPUROCMOpPatternBase<ttn::OffsetOfSts64Op, OffsetOfSts64OpPattern>;
  using Base::Base;
...
class OffsetOfStmatrixV4OpPattern
    : public NVGPUROCMOpPatternBase<ttn::OffsetOfStmatrixV4Op,
                                OffsetOfStmatrixV4OpPattern> {
public:
  using Base = NVGPUROCMOpPatternBase<ttn::OffsetOfStmatrixV4Op,
                                  OffsetOfStmatrixV4OpPattern>;
  using Base::Base;
...
class ConvertNVGPUROCMToLLVM : public ConvertNVGPUROCMToLLVMBase<ConvertNVGPUROCMToLLVM> {

public:
  explicit ConvertNVGPUROCMToLLVM() {}
...
#define POPULATE_NVGPUROCM_OP(SRC_OP, ASM)                                         \
  patterns.add<NVGPUROCMOpGenericPattern<SRC_OP>>(context, ASM, Constraints(),     \
                                              Constraints());
    POPULATE_NVGPUROCM_OP(ttn::RegAllocOp, Reg_Alloc_Op)
    POPULATE_NVGPUROCM_OP(ttn::WGMMAFenceOp, Wgmma_Fence_Op)
    POPULATE_NVGPUROCM_OP(ttn::CGABarrierSyncOp, Cga_Barrier_Sync_op)
    POPULATE_NVGPUROCM_OP(ttn::WGMMACommitGroupOp, Wgmma_Commit_Group_Op)
    POPULATE_NVGPUROCM_OP(ttn::ClusterWaitOp, Cluster_Wait_Op)
    POPULATE_NVGPUROCM_OP(ttn::FenceMBarrierInitOp, Fence_Mbarrier_Init_Op)
    POPULATE_NVGPUROCM_OP(ttn::CGABarrierArriveOp, Cga_Barrier_Arrive_Op)
    POPULATE_NVGPUROCM_OP(ttn::CGABarrierWaitOp, Cga_Barrier_Wait_Op)
    POPULATE_NVGPUROCM_OP(ttn::RegDeallocOp, Reg_Dealloc_Op)
#undef POPULATE_NVGPU_OP
    patterns.add<NVGPUROCMOpGenericPattern<ttn::MBarrierInitOp>>(
        context, Mbarrier_Init_Op, Constraints(), Constraints({"r", "b"}));
    patterns.add<NVGPUROCMOpGenericPattern<ttn::MBarrierWaitOp>>(
        context, Mbarrier_Wait_Op, Constraints(), Constraints({"r", "r"}));
    patterns.add<NVGPUROCMOpGenericPattern<ttn::NamedBarrierArriveOp>>(
        context, Named_Barrier_Arrive_Op, Constraints(),
        Constraints({"r", "r"}));
    patterns.add<NVGPUROCMOpGenericPattern<ttn::NamedBarrierWaitOp>>(
        context, Named_Barrier_Wait_Op, Constraints(), Constraints({"r", "r"}));
    patterns.add<NVGPUROCMOpGenericPattern<ttn::Sts64Op>>(
        context, Sts64_Op, Constraints(), Constraints({"r", "r", "r"}));
    patterns.add<NVGPUROCMOpGenericPattern<ttn::ClusterCTAIdOp>>(
        context, Cluster_Cta_Id_Op, Constraints({"=r"}), Constraints());
    patterns.add<NVGPUROCMOpGenericPattern<ttn::WGMMADescCreateOp>>(
...
std::unique_ptr<OperationPass<ModuleOp>> createConvertNVGPUROCMToLLVMPass() {
  return std::make_unique<::ConvertNVGPUROCMToLLVM>();
}
