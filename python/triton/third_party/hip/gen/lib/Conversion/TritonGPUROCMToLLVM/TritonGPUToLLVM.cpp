...
struct BroadcastOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::BroadcastOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::BroadcastOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::BroadcastOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
...
struct PrintOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::PrintOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::PrintOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::PrintOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
    auto loc = op->getLoc();
    Value prefixStr =
  ...
  void printTensor(triton_rocm::PrintOp op, Value prefixStr, size_t operand, size_t numOperands,
    ...
    ConvertTritonGPUROCMOpToLLVMPatternBase::PrintFormatting formatting;
...
struct AssertOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::AssertOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::AssertOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::AssertOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
    auto loc = op.getLoc();
    auto ctx = rewriter.getContext();
    auto elems = getTypeConverter()->unpackLLElements(
...
struct MakeRangeOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::MakeRangeOp> {

  MakeRangeOpConversion(
      TritonGPUROCMToLLVMTypeConverter &converter,
      ConvertTritonGPUROCMOpToLLVMPatternBase::IndexCacheInfo &indexCacheInfo,
      PatternBenefit benefit)
      : ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::MakeRangeOp>(
            converter, indexCacheInfo, benefit) {}

  LogicalResult
  matchAndRewrite(triton_rocm::MakeRangeOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
    Location loc = op->getLoc();
...
struct GetProgramIdOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::GetProgramIdOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::GetProgramIdOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::GetProgramIdOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
...
struct GetNumProgramsOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::GetNumProgramsOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::GetNumProgramsOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::GetNumProgramsOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
...
// ops.
struct GetThreadIdOpConversion : public ConvertTritonGPUROCMOpToLLVMPattern<
                                     triton_rocm::nvidia_gpu::GetThreadIdOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::nvidia_gpu::GetThreadIdOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::nvidia_gpu::GetThreadIdOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
...
struct GetClusterCTAIdOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<
          triton_rocm::nvidia_gpu::GetClusterCTAIdOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::nvidia_gpu::GetClusterCTAIdOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::nvidia_gpu::GetClusterCTAIdOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
...
struct AddPtrOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::AddPtrOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::AddPtrOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::AddPtrOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
    Location loc = op->getLoc();
    ...
    if (resultTensorTy) {
      ...
      assert(resultTy.isa<triton_rocm::PointerType>());
...
struct AllocTensorOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::gpu_rocm::AllocTensorOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::gpu_rocm::AllocTensorOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::gpu_rocm::AllocTensorOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
    Location loc = op->getLoc();
...
struct ExtractSliceOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::gpu_rocm::ExtractSliceOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::gpu_rocm::ExtractSliceOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::gpu_rocm::ExtractSliceOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
...
struct AsyncWaitOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::gpu_rocm::AsyncWaitOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::gpu_rocm::AsyncWaitOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::gpu_rocm::AsyncWaitOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
...
struct AsyncCommitGroupOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::gpu_rocm::AsyncCommitGroupOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::gpu_rocm::AsyncCommitGroupOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::gpu_rocm::AsyncCommitGroupOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
...
struct AsyncBulkWaitOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<triton_rocm::gpu_rocm::AsyncBulkWaitOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::gpu_rocm::AsyncBulkWaitOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::gpu_rocm::AsyncBulkWaitOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
    PTXBuilder ptxBuilder;
...
struct AsyncBulkCommitGroupOpConversion
    : public ConvertTritonGPUROCMOpToLLVMPattern<
          triton_rocm::gpu_rocm::AsyncBulkCommitGroupOp> {
  using ConvertTritonGPUROCMOpToLLVMPattern<
      triton_rocm::gpu_rocm::AsyncBulkCommitGroupOp>::ConvertTritonGPUROCMOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(triton_rocm::gpu_rocm::AsyncBulkCommitGroupOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
