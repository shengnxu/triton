#ifndef TRITON_CONVERSION_ROCM_TRITONGPU_TO_LLVM_UTILITY_H
#define TRITON_CONVERSION_ROCM_TRITONGPU_TO_LLVM_UTILITY_H
...
#define barSync(rewriter, op, bar, numThreads)                                 \
  do {                                                                         \
    ::mlir::triton_rocm::PTXBuilder ptxBuilder;                                     \
