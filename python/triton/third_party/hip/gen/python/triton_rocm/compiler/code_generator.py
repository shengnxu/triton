...
from ......._C.librocm_backend_for_triton.triton_rocm import ir
from ..language import constexpr, tensor
# ideally we wouldn't need any runtime component
from ..runtime import JITFunctionROCM
...
def _get_fn_file_line(fn):
    base_fn = fn
    while not isinstance(base_fn, JITFunctionROCM):
        base_fn = base_fn.fn
...
class ContainsReturnChecker(ast.NodeVisitor):
    ...
    def _visit_function(self, fn) -> bool:
        ...
        if isinstance(fn, JITFunctionROCM) and not fn.noinline:
            fn_node = fn.parse()
...
class CodeGenerator(ast.NodeVisitor):
    ...
    def call_JitFunction(self, fn: JITFunctionROCM, args, kwargs):
...
def ast_to_ttir_rocm(fn, signature, specialization, constants, debug, target):
