...
import triton.third_party.hip.gen.python.triton_rocm.language as tl
from ......._C.librocm_backend_for_triton.triton_rocm import interpreter as _interpreter
...
def _implicit_cvt(arg):
    if isinstance(arg, int):
        ty = str_to_ty(triton.third_party.hip.gen.python.triton_rocm.runtime.jit.JITFunctionROCM._type_of(triton.third_party.hip.gen.python.triton_rocm.runtime.jit.JITFunctionROCM._key_of(arg)))
...
def _unwrap(tensor):
    if isinstance(tensor, triton.third_party.hip.gen.python.triton_rocm.TensorWrapper):
        return tensor.base
    return tensor
