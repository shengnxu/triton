...
#include "triton/Dialect/NVGPUROCM/IR/Dialect.h"
#include "triton/Dialect/TritonROCM/IR/Dialect.h"
#include "triton/Dialect/TritonROCM/IR/Types.h"
#include "triton/Dialect/TritonROCM/Transforms/Passes.h"
...
#include "triton/Target/LLVMROCMIR/LLVMIRTranslation.h"
#include "triton/Target/PTXROCM/PTXTranslation.h"
#include "triton/Target/HSACO/HSACOTranslation.h"
#include "triton/Target/PTXROCM/TmaMetadata.h"
#include "triton/Tools/SysROCM/GetEnv.hpp"
#include "triton/Tools/SysROCM/GetPlatform.hpp"
...
PYBIND11_MAKE_OPAQUE(mlir::triton_rocm::gpu_rocm::TMAMetadataTy);
...
void init_triton_runtime(py::module &&m) {
  ...
  py::enum_<mlir::triton_rocm::Target>(m, "TARGET")
      .value("NVVM", mlir::triton_rocm::NVVM)
      .value("ROCDL", mlir::triton_rocm::ROCDL)
      .export_values();
}
...
private:
  ...
  bool lineInfoEnabled = !triton_rocm::tools::getBoolEnv("TRITON_DISABLE_LINE_INFO");
};
...
void init_triton_ir(py::module &&m) {
  ...
  py::enum_<mlir::triton_rocm::PaddingOption>(m, "PADDING_OPTION",
                                         py::module_local())
      .value("PAD_ZERO", mlir::triton_rocm::PaddingOption::PAD_ZERO)
      .value("PAD_NAN", mlir::triton_rocm::PaddingOption::PAD_NAN)
      .export_values();

  py::enum_<mlir::triton_rocm::CacheModifier>(m, "CACHE_MODIFIER",
                                         py::module_local())
      .value("NONE", mlir::triton_rocm::CacheModifier::NONE)
      .value("CA", mlir::triton_rocm::CacheModifier::CA)
      .value("CG", mlir::triton_rocm::CacheModifier::CG)
      .value("WB", mlir::triton_rocm::CacheModifier::WB)
      .value("CS", mlir::triton_rocm::CacheModifier::CS)
      .value("WT", mlir::triton_rocm::CacheModifier::WT)
      .export_values();

  py::enum_<mlir::triton_rocm::MemSemantic>(m, "MEM_SEMANTIC", py::module_local())
      .value("ACQUIRE_RELEASE", mlir::triton_rocm::MemSemantic::ACQUIRE_RELEASE)
      .value("ACQUIRE", mlir::triton_rocm::MemSemantic::ACQUIRE)
      .value("RELEASE", mlir::triton_rocm::MemSemantic::RELEASE)
      .value("RELAXED", mlir::triton_rocm::MemSemantic::RELAXED)
      .export_values();

  py::enum_<mlir::triton_rocm::MemSyncScope>(m, "MEM_SYNC_SCOPE", py::module_local())
      .value("GPU", mlir::triton_rocm::MemSyncScope::GPU)
      .value("CTA", mlir::triton_rocm::MemSyncScope::CTA)
      .value("SYSTEM", mlir::triton_rocm::MemSyncScope::SYSTEM)
      .export_values();

  py::enum_<mlir::triton_rocm::EvictionPolicy>(m, "EVICTION_POLICY",
                                          py::module_local())
      .value("NORMAL", mlir::triton_rocm::EvictionPolicy::NORMAL)
      .value("EVICT_FIRST", mlir::triton_rocm::EvictionPolicy::EVICT_FIRST)
      .value("EVICT_LAST", mlir::triton_rocm::EvictionPolicy::EVICT_LAST)
      .export_values();

  py::enum_<mlir::triton_rocm::RMWOp>(m, "ATOMIC_OP", py::module_local())
      .value("ADD", mlir::triton_rocm::RMWOp::ADD)
      .value("FADD", mlir::triton_rocm::RMWOp::FADD)
      .value("AND", mlir::triton_rocm::RMWOp::AND)
      .value("OR", mlir::triton_rocm::RMWOp::OR)
      .value("XOR", mlir::triton_rocm::RMWOp::XOR)
      .value("XCHG", mlir::triton_rocm::RMWOp::XCHG)
      .value("MAX", mlir::triton_rocm::RMWOp::MAX)
      .value("MIN", mlir::triton_rocm::RMWOp::MIN)
      .value("UMIN", mlir::triton_rocm::RMWOp::UMIN)
      .value("UMAX", mlir::triton_rocm::RMWOp::UMAX);

  py::class_<mlir::MLIRContext>(m, "context", py::module_local())
      .def(py::init<>())
      .def("load_triton", [](mlir::MLIRContext &self) {
        self.getOrLoadDialect<mlir::triton_rocm::TritonROCMDialect>();
           ...
           [](mlir::Value &self, std::string &name,
             ...
             if (mlir::Operation *definingOp = self.getDefiningOp())
               ...
               if (owner->isEntryBlock() &&
                   !mlir::isa<mlir::triton_rocm::FuncOp>(owner->getParentOp())) {
  ...
  py::class_<mlir::ModuleOp, mlir::OpState>(m, "module", py::module_local(),
      ...
      .def("push_back",
           [](mlir::ModuleOp &self, mlir::triton_rocm::FuncOp &funcOp) -> void {
      ...
      .def("get_function",
           [](mlir::ModuleOp &self,
              std::string &funcName) -> mlir::triton_rocm::FuncOp {
             return self.lookupSymbol<mlir::triton_rocm::FuncOp>(funcName);
           })
      .def("get_single_function",
           [](mlir::ModuleOp &self) -> mlir::triton_rocm::FuncOp {
             llvm::SmallVector<mlir::triton_rocm::FuncOp> funcs;
             self.walk(
                 [&](mlir::triton_rocm::FuncOp func) { funcs.push_back(func); });
             if (funcs.size() != 1)
  ...
  m.def(
      "parse_mlir_module_rocm",
      [](const std::string &inputFilename, mlir::MLIRContext &context) {
        // initialize registry
        // note: we initialize llvm for undef
        mlir::DialectRegistry registry;
        registry.insert<
            mlir::triton_rocm::TritonROCMDialect, mlir::triton_rocm::gpu_rocm::TritonGPUROCMDialect,
            mlir::triton_rocm::nvidia_gpu::TritonNvidiaGPUROCMDialect,
            mlir::triton_rocm::nvgpu::NVGPUROCMDialect, mlir::math::MathDialect,
  ...
  py::class_<mlir::triton_rocm::FuncOp, mlir::OpState>(m, "function",
                                                  py::module_local())
      // .def_property_readonly("attrs", &ir::function::attrs)
      // .def("add_attr", &ir::function::add_attr);
      .def("args",
           [](mlir::triton_rocm::FuncOp &self, unsigned idx) -> mlir::BlockArgument {
             return self.getArgument(idx);
           })
      .def(
          "add_entry_block",
          [](mlir::triton_rocm::FuncOp &self) -> mlir::Block * {
            return self.addEntryBlock();
          },
          ret::reference)
      .def(
          "set_arg_attr",
          [](mlir::triton_rocm::FuncOp &self, int arg_no, const std::string &name,
             int val) {
          ...
          ret::reference)
      .def("finalize",
           [](mlir::triton_rocm::FuncOp &self) -> void {
             // Remove dead code
             ...
             self.walk([&](mlir::Block *block) {
               ...
               for (auto &op : block->getOperations()) {
                 if (mlir::isa<mlir::triton_rocm::ReturnOp>(op))
                   if (retOp == nullptr) {
                     retOp = &op;
                     break;
                   }
             ...
             self.walk([&](mlir::Operation *op) {
               if (mlir::isa<mlir::triton_rocm::AdvanceOp>(op) &&
      ...
      .def_property_readonly("type", &mlir::triton_rocm::FuncOp::getFunctionType)
      .def("reset_type", &mlir::triton_rocm::FuncOp::setType);
  ...
  py::class_<TritonOpBuilder>(m, "builder", py::module_local(),
      ...
      .def("get_ptr_ty",
           [](TritonOpBuilder &self, mlir::Type &type,
             ...
             return mlir::triton_rocm::PointerType::get(type, addrSpace);
           })
      .def("get_block_ty",
      ...
      .def("get_or_insert_function",
           [](TritonOpBuilder &self, mlir::ModuleOp &module,
              ...
              std::string &visibility, bool noinline) -> mlir::triton_rocm::FuncOp {
             if (mlir::Operation *funcOperation = module.lookupSymbol(funcName))
               return llvm::dyn_cast<mlir::triton_rocm::FuncOp>(funcOperation);
             if (auto funcTy = funcType.dyn_cast<mlir::FunctionType>()) {
               ...
               return self.create<mlir::triton_rocm::FuncOp>(funcName, funcTy,
                                                        attrs);
             }
      ...
      .def("ret",
           [](TritonOpBuilder &self,
             ...
             return self.create<mlir::triton_rocm::ReturnOp>(vals);
           })
      .def("call",
           [](TritonOpBuilder &self, mlir::triton_rocm::FuncOp &func,
              std::vector<mlir::Value> &args) -> mlir::OpState {
             return self.create<mlir::triton_rocm::CallOp>(func, args);
           })
      ...
      .def("create_make_range",
           [](TritonOpBuilder &self, int start, int end) -> mlir::Value {
             ...
             return self.create<mlir::triton_rocm::MakeRangeOp>(retType, start, end);
           })
      ...
      .def("create_fp_to_fp",
           [](TritonOpBuilder &self, mlir::Value &src,
             ...
             return self.create<mlir::triton_rocm::FpToFpOp>(dstType, src);
           })
      // Conversions for standard LLVM builtin types
      .def("create_bitcast",
           [](TritonOpBuilder &self, mlir::Value &src,
              mlir::Type &dstType) -> mlir::Value {
             return self.create<mlir::triton_rocm::BitcastOp>(dstType, src);
           })
      .def("create_si_to_fp",
           [](TritonOpBuilder &self, mlir::Value &src,
              mlir::Type &dstType) -> mlir::Value {
      ...
      .def("create_addptr",
           [](TritonOpBuilder &self, mlir::Value &ptr,
             ...
             return self.create<mlir::triton_rocm::AddPtrOp>(ptr.getType(), ptr,
                                                        offset);
           })
      // Comparison (int)
      .def("create_icmpSLE",
      ...
      .def("create_load",
           [](TritonOpBuilder &self, mlir::Value &ptrs,
              mlir::triton_rocm::CacheModifier cacheModifier,
              mlir::triton_rocm::EvictionPolicy evictionPolicy,
              bool isVolatile) -> mlir::Value {
             return self.create<mlir::triton_rocm::LoadOp>(
                 ptrs, cacheModifier, evictionPolicy, isVolatile);
           })
      .def("create_store",
           [](TritonOpBuilder &self, mlir::Value &ptrs, mlir::Value &value,
              mlir::triton_rocm::CacheModifier cacheModifier,
              mlir::triton_rocm::EvictionPolicy evictionPolicy) -> void {
             self.create<mlir::triton_rocm::StoreOp>(ptrs, value, cacheModifier,
                                                evictionPolicy);
           })
      .def("create_tensor_pointer_load",
           [](TritonOpBuilder &self, mlir::Value &ptr,
              std::vector<int32_t> &boundaryCheck,
              std::optional<mlir::triton_rocm::PaddingOption> paddingOption,
              mlir::triton_rocm::CacheModifier cacheModifier,
              mlir::triton_rocm::EvictionPolicy evictionPolicy,
              bool isVolatile) -> mlir::Value {
             return self.create<mlir::triton_rocm::LoadOp>(
      ...
      .def("create_tensor_pointer_store",
           [](TritonOpBuilder &self, mlir::Value &ptr, mlir::Value &val,
              ...
              mlir::triton_rocm::CacheModifier cacheModifier,
              mlir::triton_rocm::EvictionPolicy evictionPolicy) -> void {
             self.create<mlir::triton_rocm::StoreOp>(ptr, val, boundaryCheck,
      ...
      .def("create_masked_store",
           [](TritonOpBuilder &self, mlir::Value &ptrs, mlir::Value &val,
              mlir::Value &mask, mlir::triton_rocm::CacheModifier cacheModifier,
              mlir::triton_rocm::EvictionPolicy evictionPolicy) -> void {
             self.create<mlir::triton_rocm::StoreOp>(ptrs, val, mask, cacheModifier,
                                                evictionPolicy);
           })
      .def("create_view",
           [](TritonOpBuilder &self, mlir::Value &arg,
             ...
             auto argType = arg.getType()
                                ...
                                .getElementType();
             return self.create<mlir::triton_rocm::ViewOp>(
      ...
      .def(
          ...
          [](TritonOpBuilder &self, mlir::Value &arg, int axis) -> mlir::Value {
            ...
            return self.create<mlir::triton_rocm::ExpandDimsOp>(
      ...
      .def("create_cat",
           [](TritonOpBuilder &self, mlir::Value &lhs,
             ...
             std::vector<int64_t> shape{lhsType.getShape()[0] +
                                        rhsType.getShape()[0]};
             return self.create<mlir::triton_rocm::CatOp>(
      ...
      .def("create_trans",
           [](TritonOpBuilder &self, mlir::Value &arg) -> mlir::Value {
             ...
             return self.create<mlir::triton_rocm::TransOp>(
      ...
      .def("create_broadcast",
           [](TritonOpBuilder &self, mlir::Value &arg,
             ...
             if (auto argType =
               ...
               return self.createOrFold<mlir::triton_rocm::BroadcastOp>(
      ...
      .def("create_splat",
           [](TritonOpBuilder &self, mlir::Value &arg,
              std::vector<int64_t> &shape) -> mlir::Value {
             auto argType = arg.getType();
             auto ret = self.createOrFold<mlir::triton_rocm::SplatOp>(
                 mlir::RankedTensorType::get(shape, argType), arg);
             return ret;
           })
      // // atomic
      .def("create_atomic_cas",
           [](TritonOpBuilder &self, mlir::Value &ptr, mlir::Value &cmp,
              mlir::Value &val, mlir::triton_rocm::MemSemantic sem,
              mlir::triton_rocm::MemSyncScope scope) -> mlir::Value {
             mlir::Type dstType;
             if (auto srcTensorType =
                     ptr.getType().dyn_cast<mlir::RankedTensorType>()) {
               mlir::Type dstElemType = srcTensorType.getElementType()
                                            .cast<mlir::triton_rocm::PointerType>()
                                            .getPointeeType();
             ...
             return self.create<mlir::triton_rocm::AtomicCASOp>(dstType, ptr, cmp,
                                                           val, sem, scope);
           })
      .def("create_atomic_rmw",
           [](TritonOpBuilder &self, mlir::triton_rocm::RMWOp rmwOp,
              mlir::Value &ptr, mlir::Value &val, mlir::Value &mask,
              mlir::triton_rocm::MemSemantic sem,
              mlir::triton_rocm::MemSyncScope scope) -> mlir::Value {
             mlir::Type dstType;
             if (auto srcTensorType =
                     ptr.getType().dyn_cast<mlir::RankedTensorType>()) {
             ...
             return self.create<mlir::triton_rocm::AtomicRMWOp>(
      ...
      .def("create_extern_elementwise",
           [](TritonOpBuilder &self, const std::string &libName,
             ...
             return self.create<mlir::triton_rocm::ExternElementwiseOp>(
      ...
      .def("create_get_program_id",
           [](TritonOpBuilder &self, int axis) -> mlir::Value {
             ...
             return self.create<mlir::triton_rocm::GetProgramIdOp>(
                 self.getBuilder().getI32Type(),
                 mlir::triton_rocm::ProgramIDDimAttr::get(
                     self.getBuilder().getContext(),
                     mlir::triton_rocm::ProgramIDDim(axis)));
           })
      .def("create_get_num_programs",
           [](TritonOpBuilder &self, int axis) -> mlir::Value {
             return self.create<mlir::triton_rocm::GetNumProgramsOp>(
                 self.getBuilder().getI32Type(),
      ...
      .def("create_dot",
           [](TritonOpBuilder &self, mlir::Value &a, mlir::Value &b,
             ...
             return self.create<mlir::triton_rocm::DotOp>(
      ...
      .def("create_reduce",
           [](TritonOpBuilder &self, std::vector<mlir::Value> operands,
             ...
             return self.create<mlir::triton_rocm::ReduceOp>(operands, axis);
           })
      .def("create_reduce_ret",
           [](TritonOpBuilder &self, py::args args) -> mlir::OpState {
             ...
             return self.create<mlir::triton_rocm::ReduceReturnOp>(return_values);
           })
      .def("create_scan",
           [](TritonOpBuilder &self, std::vector<mlir::Value> operands,
              int axis) -> mlir::OpState {
             return self.create<mlir::triton_rocm::ScanOp>(operands, axis);
           })
      .def("create_scan_ret",
           [](TritonOpBuilder &self, py::args args) -> mlir::OpState {
             llvm::SmallVector<mlir::Value> return_values;
             ...
             return self.create<mlir::triton_rocm::ScanReturnOp>(return_values);
           })
      .def("create_ptr_to_int",
           [](TritonOpBuilder &self, mlir::Value &val,
              mlir::Type &type) -> mlir::Value {
             return self.create<mlir::triton_rocm::PtrToIntOp>(type, val);
           })
      .def("create_int_to_ptr",
           [](TritonOpBuilder &self, mlir::Value &val,
              mlir::Type &type) -> mlir::Value {
             return self.create<mlir::triton_rocm::IntToPtrOp>(type, val);
           })
      .def("create_select",
           [](TritonOpBuilder &self, mlir::Value &condition,
      ...
      .def("create_inline_asm",
           [](TritonOpBuilder &self, const std::string &inlineAsm,
             ...
             return self.create<mlir::triton_rocm::ElementwiseInlineAsmOp>(
      ...
      .def("create_print",
           [](TritonOpBuilder &self, const std::string &prefix,
             ...
             self.create<mlir::triton_rocm::PrintOp>(
      ...
      .def("create_assert",
           [](TritonOpBuilder &self, mlir::Value &condition,
             ...
             self.create<mlir::triton_rocm::AssertOp>(condition, messageAttr,
      ...
      .def("create_make_block_ptr",
           [](TritonOpBuilder &self, mlir::Value &base,
             ...
             return self.create<mlir::triton_rocm::MakeTensorPtrOp>(
      ...
      .def("create_advance",
           [](TritonOpBuilder &self, mlir::Value &ptr,
             ...
             return self.create<mlir::triton_rocm::AdvanceOp>(ptr.getType(), ptr,
                                                         offsets);
           });
  ...
  py::class_<mlir::PassManager>(m, "pass_manager", py::module_local())
      ...
      .def("enable_debug",
           [](mlir::PassManager &self) {
             if (!::triton_rocm::tools::getBoolEnv("MLIR_ENABLE_DUMP"))
               return;
      ...
      .def("add_plan_cta_pass",
           [](mlir::PassManager &self,
              mlir::triton_rocm::nvidia_gpu::ClusterInfo &clusterInfo) {
             self.addPass(mlir::createTritonNvidiaGPUROCMPlanCTAPass(&clusterInfo));
           })
      .def("add_tritongpu_coalesce_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::createTritonGPUROCMCoalescePass());
           })
      .def("add_tritongpu_optimize_thread_locality_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::createTritonGPUROCMOptimizeThreadLocalityPass());
           })
      ...
      .def("add_triton_combine_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::triton_rocm::createCombineOpsPass());
           })
      .def("add_reorder_broadcast_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::triton_rocm::createReorderBroadcastPass());
           })
      .def("add_rewrite_tensor_pointer_pass",
           [](mlir::PassManager &self, int computeCapability, bool isROCM) {
             self.addPass(mlir::triton_rocm::createRewriteTensorPointerPass(
                 computeCapability, isROCM));
           })
      .def("add_tritongpu_ws_feasibility_checking_pass",
           [](mlir::PassManager &self, int computeCapability) {
             self.addPass(mlir::createTritonNvidiaGPUROCMWSFeasibilityCheckingPass(
                 computeCapability));
           })
      .def("add_tritongpu_wsdecomposing_pass",
           [](mlir::PassManager &self, int computeCapability) {
             self.addPass(mlir::createTritonNvidiaGPUROCMWSDecomposingPass(
                 computeCapability));
           })
      .def("add_tritongpu_wspipeline_pass",
           [](mlir::PassManager &self, int numStages, int numWarps,
              int computeCapability) {
             self.addPass(mlir::createTritonNvidiaGPUROCMWSPipelinePass(
                 numStages, numWarps, computeCapability));
           })
      .def("add_tritongpu_wsmutex_pass",
           [](mlir::PassManager &self, int computeCapability) {
             self.addPass(
                 mlir::createTritonNvidiaGPUROCMWSMutexPass(computeCapability));
           })
      .def("add_tritongpu_wsmaterialization_pass",
           [](mlir::PassManager &self, int computeCapability) {
             self.addPass(mlir::createTritonNvidiaGPUROCMWSMaterializationPass(
                 computeCapability));
           })
      .def("add_tritongpu_ws_fixup_missing_attrs_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::createTritonNvidiaGPUROCMWSFixupMissingAttrs());
           })
      .def(
          ...
          [](mlir::PassManager &self, int numWarps, int threadsPerWarp,
            ...
            self.addPass(mlir::triton_rocm::createConvertTritonToTritonGPUROCMPass(
      ...
      .def("add_tritongpu_pipeline_pass",
           [](mlir::PassManager &self, int numStages, int numWarps, int numCTAs,
              int computeCapability) {
             self.addPass(mlir::createTritonGPUROCMPipelinePass(
      ...
      .def("add_tritongpu_materialize_load_store_pass",
           [](mlir::PassManager &self, int numWarps, int computeCapability) {
             self.addPass(mlir::createTritonNvidiaGPUROCMMaterializeLoadStorePass(
                 numWarps, computeCapability));
           })
      .def("add_tritongpu_stream_pipeline_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::createTritonGPUROCMStreamPipelinePass());
           })
      .def("add_tritongpu_prefetch_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::createTritonGPUROCMPrefetchPass());
           })
      .def("add_tritongpu_accelerate_matmul_pass",
           [](mlir::PassManager &self, int computeCapability) {
             self.addPass(
                 mlir::createTritonGPUROCMAccelerateMatmulPass(computeCapability));
           })
      ...
      .def("add_tritongpu_optimize_dot_operands_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::createTritonGPUROCMOptimizeDotOperandsPass());
           })
      .def("add_tritongpu_remove_layout_conversions_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::createTritonGPUROCMRemoveLayoutConversionsPass());
           })
      .def("add_tritongpu_optimize_epilogue_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::createTritonGPUROCMOptimizeEpiloguePass());
           })
      .def("add_tritongpu_reorder_instructions_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::createTritonGPUROCMReorderInstructionsPass());
           })
      .def("add_tritongpu_rewrite_tensor_pointer_pass",
           [](mlir::PassManager &self, int computeCapability) {
             self.addPass(mlir::createTritonGPUROCMRewriteTensorPointerPass(
                 computeCapability));
           })
      .def("add_tritongpu_decompose_conversions_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::createTritonGPUROCMDecomposeConversionsPass());
           })
      .def("add_tritongpu_fence_insertion_pass",
           [](mlir::PassManager &self) {
             self.addPass(mlir::createTritonNvidiaGPUROCMFenceInsertionPass());
           })
      .def("add_triton_gpu_to_llvm",
           [](mlir::PassManager &self) {
             self.addPass(mlir::triton_rocm::createConvertTritonGPUROCMToLLVMPass());
           })
      .def("add_nv_gpu_to_llvm",
           [](mlir::PassManager &self) {
             self.addPass(mlir::triton_rocm::createConvertNVGPUROCMToLLVMPass());
           })
  ...
  m.def("is_ws_supported", [](mlir::ModuleOp &mod) -> bool {
    return mlir::triton_rocm::nvidia_gpu::TritonNvidiaGPUROCMDialect::getWSSupportedAttr(
        mod);
  });
}
...
void init_triton_env_vars(py::module &m) {
  m.def("get_env_vars", []() -> std::map<std::string, bool> {
    ...
    for (const auto &envVar : triton_rocm::ENV_VARS) {
      envVars[envVar] = triton_rocm::tools::getBoolEnv(envVar);
    }
    return envVars;
  });
}
...
void init_triton_translation(py::module &m) {
  ...
  py::class_<mlir::triton_rocm::nvidia_gpu::ClusterInfo>(m, "ClusterInfo")
      .def(py::init<>())
      .def_readwrite("clusterDimX",
                     &mlir::triton_rocm::nvidia_gpu::ClusterInfo::clusterDimX)
      .def_readwrite("clusterDimY",
                     &mlir::triton_rocm::nvidia_gpu::ClusterInfo::clusterDimY)
      .def_readwrite("clusterDimZ",
                     &mlir::triton_rocm::nvidia_gpu::ClusterInfo::clusterDimZ)
      .def("__repr__", [](mlir::triton_rocm::nvidia_gpu::ClusterInfo &self) {
  ...
  py::class_<mlir::triton_rocm::gpu_rocm::TMAInfo>(m, "TMAInfo")
      .def(py::init<>())
      .def_readwrite("tensorDataType",
                     &mlir::triton_rocm::gpu_rocm::TMAInfo::tensorDataType)
      .def_readwrite("tensorRank", &mlir::triton_rocm::gpu_rocm::TMAInfo::tensorRank)
      .def_readwrite("globalAddressArgIdx",
                     &mlir::triton_rocm::gpu_rocm::TMAInfo::globalAddressArgIdx)
      .def_readwrite("globalStridesArgIdx",
                     &mlir::triton_rocm::gpu_rocm::TMAInfo::globalStridesArgIdx)
      .def_readwrite("globalDimsArgIdx",
                     &mlir::triton_rocm::gpu_rocm::TMAInfo::globalDimsArgIdx)
      .def_readwrite("boxDims", &mlir::triton_rocm::gpu_rocm::TMAInfo::boxDims)
      .def_readwrite("elementStrides",
                     &mlir::triton_rocm::gpu_rocm::TMAInfo::elementStrides)
      .def_readwrite("interleave", &mlir::triton_rocm::gpu_rocm::TMAInfo::interleave)
      .def_readwrite("swizzle", &mlir::triton_rocm::gpu_rocm::TMAInfo::swizzle)
      .def_readwrite("l2Promotion", &mlir::triton_rocm::gpu_rocm::TMAInfo::l2Promotion)
      .def_readwrite("oobFill", &mlir::triton_rocm::gpu_rocm::TMAInfo::oobFill)
      .def_readwrite("TMADescArgIdx",
                     &mlir::triton_rocm::gpu_rocm::TMAInfo::TMADescArgIdx);
  py::bind_vector<std::vector<mlir::triton_rocm::gpu_rocm::TMAInfo>>(m, "TMAInfos");
  ...
  m.def(
      ...
      [](mlir::ModuleOp op, int computeCapability,
         mlir::triton_rocm::gpu_rocm::TMAMetadataTy &tmaInfos,
         mlir::triton_rocm::Target target, int wavesPerEU) {
        py::gil_scoped_release allow_threads;
        llvm::LLVMContext llvmContext;
        auto llvmModule = ::mlir::triton_rocm::translateTritonGPUROCMToLLVMIR(
  ...
  m.def(
      ...
      [](const std::string llvmIR, int capability, int version,
        ...
        auto ptxCode = triton_rocm::translateLLVMIRToPTX(*module, capability,
  ...
  m.def("compile_ptx_to_cubin",
        [](const std::string &ptxCode, const std::string &ptxasPath,
          ...
          std::string cubin;
          {
            ...
            auto lineInfoOption =
                triton_rocm::tools::getBoolEnv("TRITON_DISABLE_LINE_INFO")
                    ? ""
                    : " -lineinfo";
  ...
  m.def("add_external_libs",
        [](mlir::ModuleOp &op, const std::vector<std::string> &names,
          ...
          ::mlir::triton_rocm::addExternalLibs(op, names, paths);
        });
  ...
  m.def(
      ...
      [](const std::string llvmIR, std::string gfx_arch, std::string gfx_triple,
        ...
        auto hsacoCode = ::mlir::triton_rocm::translateLLVMIRToHSACO(
