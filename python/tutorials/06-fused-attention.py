...
def _attn_bwd(Q, K, V, sm_scale,  #
              ...
              BLOCK_DMODEL: tl.constexpr):
    # comments for batch 4 heads 16, seqlen 4096
    LN2: tl.constexpr = 0.6931471824645996  # = ln(2)
    # grid = (N_CTX // BLOCK_N1, 1, BATCH * N_HEAD)
    # M1, N1, M2, N2 = 64, 64, 64, 64
    ...
    # This is seqlen offset. For pid 1 = 64 along seqlen
    start_n = pid * BLOCK_N1
    start_m = start_n

    # This should be M for dkdv kernel for the diagonal. 64 / 2 = 32
