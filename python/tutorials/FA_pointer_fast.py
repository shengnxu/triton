...
def _fwd_kernel(
    ...
    L,
    Out,
    stride_qz, stride_qh, stride_qm, stride_qk, # %arg9
    stride_kz, stride_kh, stride_kn, stride_kk, #arg13
    stride_vz, stride_vh, stride_vk, stride_vn, #arg17
    ...
    k_ptrs = K + off_hz * stride_qh + offs_n[None, :] * stride_kn + offs_d[:, None] * stride_kk
    v_ptrs = V + off_hz * stride_qh + offs_n[:, None] * stride_qm + offs_d[None, :] * stride_qk
...
test_op_fwd(4, 48, 16384, 64, 0, False)
